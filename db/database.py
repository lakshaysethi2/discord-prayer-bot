"""SQLite connection factory + migration runner for the prayer bot."""
...
_DEFAULT_PATH = "./data/prayer_bot.db"


def get_default_path() -> str:
    """Read `DATABASE_PATH` from env or fall back to `./data/prayer_bot.db`."""
